...
DEFAULT_AGENT_CONFIGS = [
    ...
    {
        "name": "dlc_manager",
        "display_name": "DLC/Mod 管理",
        "type": "dlc_manager",
        "config": {"auto_update": True, "conflict_detection": True}
    },
    {
    ...
    },
    {
        ...
        "display_name": "存档管理",
        "type": "save_manager",
        "config": {"auto_backup": True, "cloud_sync": True}
    },
    {
        "name": "update_manager",
        "display_name": "更新管理",
        "type": "update_manager",
        "config": {"auto_update": True, "beta_opt_in": False}
    },
    {
    ...
    },
    {
        ...
        "display_name": "性能分析",
        "type": "performance",
        "config": {"detailed_analysis": True, "optimization_suggestions": True}
    },
    {
        "name": "security_agent",
        "display_name": "安全防护",
        "type": "security",
        "config": {"anti_cheat_check": True, "scan_frequency": "daily"}
    },
    {
        "name": "audio_expert",
        "display_name": "音频专家",
...
_AGENT_REGISTRY: List[tuple[str, str, str]] = [
    ...
    ("dlc_manager", "..agents.dlc.dlc_manager_agent", "DLCManagerAgent"),
    ("launch_optimizer", "..agents.optimization.launch_optimizer_agent", "LaunchOptimizerAgent"),
    ("save_manager", "..agents.saves.save_manager_agent", "SaveManagerAgent"),
    ("update_manager", "..agents.updates.update_manager_agent", "UpdateManagerAgent"),
    ("community", "..agents.community.community_agent", "CommunityAgent"),
    ("social", "..agents.social.social_agent", "SocialAgent"),
    ("performance", "..agents.performance.performance_analyst_agent", "PerformanceAnalystAgent"),
    ("security", "..agents.security.security_agent", "SecurityAgent"),
